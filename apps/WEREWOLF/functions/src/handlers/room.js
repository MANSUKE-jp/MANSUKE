...
exports.sendChatMessageHandler = async (request) => {
    ...
    const uid = request.auth.uid;
    const roomDocRef = db.collection('artifacts').doc('mansuke-jinro').collection('public').doc('data').collection('rooms').doc(roomCode);
...
exports.heartbeatHandler = async (request) => {
    ...
    const playerRef = db.collection('artifacts').doc('mansuke-jinro').collection('public').doc('data').collection('rooms').doc(roomCode).collection('players').doc(uid);
