...
export const RoleRevealScreen = ({ role, teammates }) => {
    ...
    // サーバー通信のラグ対策
    if (!role) return <div className="min-h-screen bg-black flex items-center justify-center text-white flex-col gap-4">
        <Loader className="animate-spin text-purple-400" size={48} />
        <span className="font-bold tracking-widest text-lg animate-pulse">役職データを取得中...</span>
    </div>;
